...
export class ConfigManager {
  ...
  private loadEnvironment(): void {
    ...
    this._environment = {
      ...
      LOG_FORMAT: process.env.LOG_FORMAT as any,
   ...
   */
  public loadConfig(configPath?: string): ConfigValidationResult {
    try {
      // Default config path
   ...
   */
  public reload(configPath?: string): ConfigValidationResult {
    this._config = null;
    this.loadEnvironment();
   ...
   */
  public isFeatureEnabled(feature: keyof RuntimeConfig['features']): boolean {
